    ...
    return (
        <div className="position-absolute top-50 start-50 translate-middle row">
            <div className="col bg-gray rounded-start-3 p-5">
                ...
                <input className="form-control login-input py-2 px-4 rounded mt-3" type="text" name="user" id="txtUser" placeholder="Usuario" />
            ...
            <div className="col bg-indigo p-5 rounded-end-3">
                ...
                <input className="form-control login-input py-2 px-4 rounded mt-2" type="text" name="name" id="txtName" placeholder="Nombre" />
                <input className="form-control login-input py-2 px-4 rounded mt-2" type="text" name="lastname" id="txtApe" placeholder="Apellido" />
            </div>
