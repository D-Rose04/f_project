      ...
      <div className="row h-100">
        <div className="col-4 col-sm-3 col-lg-2 d-flex flex-column align-items-center p-2 side-bar">
          ...
          <div className="navigation-links mt-3 d-flex flex-column flex-grow-1 gap-3 mt-5 ms-xl-3">
            ...
            <NavigationLink href={"/"} icon={"lost"} className={"d-flex align-items-center"}>Mascotas Perdidas</NavigationLink>
            <NavigationLink href={"/"} icon={"my-pets"} className={"d-flex align-items-center"}>Mis Mascotas</NavigationLink>
          ...
          <div className="layout-header d-flex justify-content-between mt-2 w-100">
            ...
            <div className="">
              <div className="d-flex flex-row-reverse justify-content-between align-items-center">
                ...
                <NotificationButton href={'#'} count={9} image={'chat'} />
              </div>
            </div>
          </div>
          <div className="layout-row overflow-y-scroll row mt-1">
