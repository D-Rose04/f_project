export const INVALID_EMAIL_FORMAT = "El formato del correo electrónico es incorrecto.";
export const INVALID_PASSWORD = "La contraseña debe contener mínimo 8 carácteres y no más de 32, al menos una letra mayúscula, una letra minuscula y un número.";
